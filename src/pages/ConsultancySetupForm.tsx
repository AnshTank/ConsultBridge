...
const ConsultancySetupForm: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    price: "",
    whyChooseUs: "",
    image: "https://images.unsplash.com/photo-1560179707-f14e90ef3623?w=800&auto=format&fit=crop&q=60", // Default image
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h1 className="text-3xl font-bold text-center mb-2">Consultancy Setup</h1>
