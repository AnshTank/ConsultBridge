        ...
        <section className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white py-20">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-xl text-indigo-100 max-w-2xl mx-auto">
              Your privacy and data security are fundamental to our mission of connecting consultants and clients safely
            </p>
          </div>
        </section>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-10">
              ...
              <div className="space-y-12">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold mb-4 text-gray-800">How We Use Your Information</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold mb-4 text-gray-800">Information Sharing & Disclosure</h3>
                    <div className="bg-red-50 border border-red-200 p-4 rounded-lg mb-4">
                      <p className="text-red-800 font-semibold">We DO NOT sell your personal information to third parties.</p>
                    </div>
                    <div className="space-y-3">
                      <div className="flex items-center space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                        <span className="text-gray-700"><strong>With Consultants:</strong> Basic contact info for confirmed appointments</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                        <span className="text-gray-700"><strong>Legal Requirements:</strong> When required by law or legal process</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                        <span className="text-gray-700"><strong>Service Providers:</strong> Trusted partners for payment processing and analytics</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold mb-4 text-gray-800">Data Security & Protection</h3>
                    <div className="grid md:grid-cols-3 gap-4">
                      ...
                      <div className="text-center p-4 bg-gray-50 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600">Industry-standard secure data centers</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold mb-4 text-gray-800">Your Rights & Choices</h3>
                    <div className="bg-gradient-to-r from-yellow-50 to-orange-50 p-6 rounded-lg border border-yellow-200">
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          <h4 className="font-semibold text-gray-800 mb-2">Data Rights</h4>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="space-y-2">
                        <p><strong>Email:</strong> privacy@consultbridge.com</p>
                    ...
                    <div className="bg-white/10 p-4 rounded-lg">
                      ...
                      <p className="text-sm">We respond to privacy inquiries within 48 hours and resolve requests within 30 days as required by applicable privacy laws.</p>
                    </div>
                  </div>
                </div>
              </div>
